...
<div class="article">
  ...
  <h2>All Frequently Asked Questions</h2>
      ...
      <a href="/about/contact/" class="button faq-submit">Submit a Question...</a>
      
    </form>
    
    <div class="post-entry">    
		<?php while (have_posts()) : the_post(); ?>
		    <a href="<?php the_permalink() ?>" rel="bookmark" title="<?php the_title_attribute(); ?>" class="faq_list_links" >
          <?php the_title(); ?>
        </a>
